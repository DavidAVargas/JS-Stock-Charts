async function main() {
    ...
    const apiKey = '31f7e22033cb4f47a9beddd16ffebe56';
    const symbols = ['GME', 'MSFT', 'DIS', 'BNTX'];
    const apiUrl = `https://api.twelvedata.com/time_series?apikey=31f7e22033cb4f47a9beddd16ffebe56&symbol=GME,MSFT,DIS,BNTX&interval=1day`;
